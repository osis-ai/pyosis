...
def build_nodes(engine: OSISEngine) -> list[int]:
    ...
    # 显式编号创建节点
    n1  = node.create(1,0.0300, 0.0000, 0.0000)
    _expect_attr(n1, "no", 1)
    n2  = node.create(2,0.4600, 0.0000, 0.0000)
    _expect_attr(n2, "no", 2)
    n3  = node.create(3,0.6800, 0.0000, 0.0000)
    _expect_attr(n3, "no", 3)
    n4  = node.create(4,1.6800, 0.0000, 0.0000)
    _expect_attr(n4, "no", 4)
    n5  = node.create(5,2.8400, 0.0000, 0.0000)
    _expect_attr(n5, "no", 5)
    n6  = node.create(6,4.0000, 0.0000, 0.0000)
    _expect_attr(n6, "no", 6)
    n7  = node.create(7,6.0000, 0.0000, 0.0000)
    _expect_attr(n7, "no", 7)
    n8  = node.create(8,8.0000, 0.0000, 0.0000)
    _expect_attr(n8, "no", 8)
    n9  = node.create(9,10.0000, 0.0000, 0.0000)
    _expect_attr(n9, "no", 9)
    n10 = node.create(10,12.0000, 0.0000, 0.0000)
    _expect_attr(n10, "no", 10)
    n11 = node.create(11,13.1600, 0.0000, 0.0000)
    _expect_attr(n11, "no", 11)
    n12 = node.create(12,14.3200, 0.0000, 0.0000)
    _expect_attr(n12, "no", 12)
    n13 = node.create(13,15.3200, 0.0000, 0.0000)
    _expect_attr(n13, "no", 13)
    n14 = node.create(14,15.5400, 0.0000, 0.0000)
    _expect_attr(n14, "no", 14)
    n15 = node.create(15,15.9700, 0.0000, 0.0000)
