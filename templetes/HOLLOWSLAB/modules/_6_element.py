...
def build_elements(engine: OSISEngine, mat_no: list[int], sec_no: list[int], node_no: list[int]) -> list[int]:
    ...
    element.group("钢束-1-N1线型单元", "a", elem_no[0:13])
    element.group("钢束-2-N2线型单元", "c")
    element.group("钢束-2-N2线型单元", "a", elem_no[0:13])
    element.group("主梁单元", "c")
    element.group("主梁单元", "a", elem_no[0:13])
