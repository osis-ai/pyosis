...
class Stage:
    ...
    accumulation: float
    pre_stage_no: int
    element_groups: list[dict] | None = None
    boundary_groups: list[dict] | None = None
    load_cases: list[dict] | None = None
    analysis_cases: list[dict] | None = None
    ...
    def _from_dict(cls, d: dict) -> Stage:
        ...
        return cls(
            ...
            element_groups=d.get("elementGroups", []),
            boundary_groups=d.get("boundaryGroups", []),
            load_cases=d.get("loadCases", []),
            analysis_cases=d.get("analysisCases", []),
        )
